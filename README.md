...
echo. >> README.md
echo ## Módulo Backend >> README.md
echo API REST de autenticación con Node.js, Express, MySQL y JWT. Pruebas unitarias Jest 20/20. >> README.md
git add README.md
git commit -m "docs(backend): documentar módulo de autenticación y pruebas Jest"
